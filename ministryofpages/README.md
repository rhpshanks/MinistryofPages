# Ministry of Pages — website

Single-page site for ministryofpages.com. Static: one HTML file plus images. No build step, no dependencies.
...
```bash
python -m http.server 5183 -d ministryofpages
```
